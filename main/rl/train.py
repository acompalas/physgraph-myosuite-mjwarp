...
def launch_rlg_hydra(cfg: DictConfig):
    ...
    from lib.rl.network_builder_myohand_transformer import MyoHandTransformerBuilder
    ...
    register_network("myohand_transformer_actor_critic", MyoHandTransformerBuilder)
