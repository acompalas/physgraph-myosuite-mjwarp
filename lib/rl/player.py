...
class MyPPOPlayerContinuous(MyBasePlayer):
    ...
    def get_action(self, obs, is_deterministic=False):
        ...
        if "base_actions" in res_dict:
            current_action = current_action #torch.cat([res_dict["base_actions"], current_action], dim=1)
        if self.has_batch_dimension == False:
    ...
    def restore(self, fn):
        if type(fn) is str:
            ...
            '''
            print("checkpoint['model']", checkpoint['model'].keys())
            filter_keys = ["running_mean_std.running_mean_std.obs_lh.running_mean", 
                           "running_mean_std.running_mean_std.obs_lh.running_var", 
                           "running_mean_std.running_mean_std.obs_lh.count", 
                           "running_mean_std.running_mean_std.obs_lh_target.running_mean", 
                           "running_mean_std.running_mean_std.obs_lh_target.running_var", 
                           "running_mean_std.running_mean_std.obs_lh_target.count", 
                           "running_mean_std.running_mean_std.obs_llinks.running_mean", 
                           "running_mean_std.running_mean_std.obs_llinks.running_var", 
                           "running_mean_std.running_mean_std.obs_llinks.count", 
                           "running_mean_std.running_mean_std.obs_obj.running_mean", 
                           "running_mean_std.running_mean_std.obs_obj.running_var", 
                           "running_mean_std.running_mean_std.obs_obj.count", 
                           "running_mean_std.running_mean_std.obs_obj_target.running_mean", 
                           "running_mean_std.running_mean_std.obs_obj_target.running_var", 
                           "running_mean_std.running_mean_std.obs_obj_target.count", 
                           "running_mean_std.running_mean_std.obs_rh.running_mean", 
                           "running_mean_std.running_mean_std.obs_rh.running_var", 
                           "running_mean_std.running_mean_std.obs_rh.count", 
                           "running_mean_std.running_mean_std.obs_rh_target.running_mean", 
                           "running_mean_std.running_mean_std.obs_rh_target.running_var", 
                           "running_mean_std.running_mean_std.obs_rh_target.count", 
                           "running_mean_std.running_mean_std.obs_rlinks.running_mean", 
                           "running_mean_std.running_mean_std.obs_rlinks.running_var", 
                           "running_mean_std.running_mean_std.obs_rlinks.count", 
                           "running_mean_std.running_mean_std.obs_tool.running_mean", 
                           "running_mean_std.running_mean_std.obs_tool.running_var", 
                           "running_mean_std.running_mean_std.obs_tool.count", 
                           "running_mean_std.running_mean_std.obs_tool_target.running_mean", 
                           "running_mean_std.running_mean_std.obs_tool_target.running_var", 
                           "running_mean_std.running_mean_std.obs_tool_target.count"]
