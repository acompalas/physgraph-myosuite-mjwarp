...
class BaseModelNetwork(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        if normalize_input:
            #print("isinstance(obs_shape, spaces.Dict)_hahahahahahaahahaha", isinstance(obs_shape, spaces.Dict))
    ...
    def norm_obs(self, observation):
        with torch.no_grad():
            #print("hahahaha")
            return observation #self.running_mean_std(observation) if self.normalize_input else observation
