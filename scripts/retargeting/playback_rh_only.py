"""Right hand + source mug (O02@0015@00020, the one being poured)
...
mug = mujoco.MjSpec.from_file(str(proj_root / "assets/objects/O02@0015@00020/O02@0015@00020.xml"))
...
dh = MyoHandR()
root_adr = model.jnt_qposadr[mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_JOINT, "root_r")]
dof_adrs = np.array([model.jnt_qposadr[mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_JOINT, n)] for n in dh.dof_names])
mug_jid = mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_JOINT, "mug_O02@0015@00020_free")
